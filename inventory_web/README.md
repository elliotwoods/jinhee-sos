...
- Status/detail/timestamp-only differences resolve automatically (newest wins).
  Real conflicts (number, tag or role changed differently on both computers)
  block the whole sync until you select them and choose **keep local** or **take web**.
