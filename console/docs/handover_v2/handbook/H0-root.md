...
Version 1 ({{v1-root}}) is unchanged. It describes the older separate apps, which still work as a fallback.
<kr>1판({{v1-root}})은 변경하지 않았습니다. 1판은 이전의 개별 앱을 설명하며, 이 앱들은 지금도 예비 수단으로 동작합니다.</kr>
