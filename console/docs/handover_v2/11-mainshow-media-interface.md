...
1. **Open Show editor** (top bar, ⌘5). The working copy is saved on this computer as you edit; the chips under the title say whether it matches the published version.<br>**Show editor**를 엽니다(상단, ⌘5). 편집 내용은 이 컴퓨터에 자동 저장되며, 제목 아래 칩이 게시 버전과 같은지 알려 줍니다.
