...
// 컴파일이 되도록 빈 상태에서는 더미 1개를 둠.
// 실제 데이터를 넣으면 아래 내용을 교체할 것.
...
#define CUBE_TABLE_READY true

// 실제 등록 데이터를 넣은 뒤에는 true로 변경
...
void sendPreshowCommand(
  ...
  // Peer를 계속 쌓지 않음
  //
  // 140대 운영 시 ESP-NOW Peer 20개 제한 방지
  // ---------------------------------------------------
